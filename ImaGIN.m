...
uicontrol(Fmenu,'Style','PopUp',...
    ...
    'CallBack','spm(''PopUpCB'',gcbo)',...
	'UserData',{'ImaGIN_BPFilter;','ImaGIN_NotchFilter;','ImaGIN_spm_eeg_downsample;','ImaGIN_StimDetect;','ImaGIN_ArtefactCorrectionModel;'},...
    'Tag', 'EEG')
