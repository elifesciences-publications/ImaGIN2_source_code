...
uicontrol(Fmenu,'Style','PopUp',...
    'String','Other...|Bandpass filter|Notch filter|Re-reference|Downsample|Time-frequency|Grand mean|Merge|3Dimages|Average TF',...
	'Position',[265 345 100 030].*WS,...
	'ToolTipString','Other preprocessing functions',...
	'FontSize',FS(10),...
    'CallBack','spm(''PopUpCB'',gcbo)',...
	'UserData',{'ImaGIN_BPFilter;','ImaGIN_NotchFilter;','try, spm_eeg_rereference; catch, spm_eeg_reref_eeg; end','ImaGIN_spm_eeg_downsample;','spm_eeg_tf;',...
