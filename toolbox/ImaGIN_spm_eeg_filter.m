function D = ImaGIN_spm_eeg_filter(S)
% Filter M/EEG data
...
Dnew = clone(D, FileOut, [D.nchannels D.nsamples D.ntrials]);

% determine channels for filtering
Fchannels = unique([indchantype(D,'MEEG'), indchantype(D,'EOG')]);
